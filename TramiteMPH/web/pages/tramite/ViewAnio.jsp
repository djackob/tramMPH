        ...
        <aside class="right-side">
            ...
            <section class="content-header">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="active">Registro de Anio</li>
                </ol>
            </section>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <form id="form" role="form">
                            <div class="box box-primary">
                                <div class="box-header">
                                    <h3 class="box-title">Registro de Año</h3>
                                </div>
                                <div class="box-body">
                                    <!-- Date range -->
                                    <div class="form-group">
                                        <label>Ingrese Año <i style="color:red ">*</i> :</label>
                                        <input obligatorio solonumeros id="txtDenominacion" class="form-control input-sm" type="text" placeholder="2015" maxlength="4">
                                    </div>                                </div><!-- /.box-body -->
