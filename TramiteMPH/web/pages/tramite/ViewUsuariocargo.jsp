...
<html>
    <meta charset="UTF-8">
    <title>Registro Usuariocargo</title>
...
<body class="skin-blue">
    ...
    <div class="wrapper row-offcanvas row-offcanvas-left">
        ...
        <aside class="right-side">
            ...
            <section class="content-header">
                <h1>
                    Registro de Usuariocargo
                    <small>Administracion de usuarios</small>
                </h1>
                <ol class="breadcrumb">
                    <li><a href="#"><i class="fa fa-unlock-alt"></i> Usuariocargo</a></li>
                    <li class="active">Registro de Usuariocargo</li>
                </ol>
            </section>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <form id="form" role="form">
                            <div class="box box-primary">
                                <div class="box-header">
                                    <h3 class="box-title">Registro de Usuariocargo</h3>
                                </div>
                                <div class="box-body">
                                    <!-- Date range -->
 <div class="form-group">
                                        ...
                                        <label>Idcargo :</label>
                                        <select obligatorio id="txtIdcargo" class="form-control input-sm">
                                        </select>
                                    </div>   <div class="form-group">
                                        <label>Fechaasignado :</label>
                                        <input obligatorio id="txtFechaasignado" class="form-control input-sm" type="text" placeholder="Ingrese Fechaasignado">
                                    </div>                                </div><!-- /.box-body -->
    ...
    <script src="${pageContext.request.contextPath}/js/SISTEMA/JSUsuariocargo.js" type="text/javascript"></script>
