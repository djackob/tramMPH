...
<body class="skin-blue">
    ...
    <div class="wrapper row-offcanvas row-offcanvas-left">
        ...
        <aside class="right-side">
            ...
            <section class="content-header">
                ...
                <ol class="breadcrumb">
                    <li><a href="#"><i class="fa fa-unlock-alt"></i> Feriado</a></li>
                    <li class="active">Registro de Feriado</li>
                </ol>
            </section>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <form id="form" role="form">
                            <div class="box box-primary">
                                <div class="box-header">
                                    <h3 class="box-title">Registro de Feriado</h3>
                                </div>
                                <div class="box-body">
                                    <!-- Date range -->
 <div class="form-group">
                                        ...
                                        <label>Motivo :</label>
                                        <input obligatorio id="txtMotivo" class="form-control input-sm" type="text" placeholder="Ingrese Motivo">
                                    </div>                                </div><!-- /.box-body -->
