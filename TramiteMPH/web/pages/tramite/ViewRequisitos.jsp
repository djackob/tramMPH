...
<html>
    <meta charset="UTF-8">
    <title>Registro Requisitos</title>
...
<body class="skin-blue">
        ...
        <aside class="right-side">
            ...
            <section class="content-header">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="active">Registro de Requisitos</li>
                </ol>
            </section>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <form id="form" role="form">
                            <div class="box box-primary">
                                <div class="box-header">
                                    <h3 class="box-title">Registro de Requisitos</h3>
                                </div>
                                <div class="box-body">
                                    <!-- Date range -->
 <div class="form-group">
    ...
    <script src="${pageContext.request.contextPath}/js/SISTEMA/JSRequisitos.js" type="text/javascript"></script>
